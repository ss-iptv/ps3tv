...
new page.Route(plugin.id + ":start", function(page) {
   ...
   page.appendItem("", "separator", {
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/menu/menu_animes.m3u:Animes', "directory", {
            title: 'Animes',
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/menu/menu_documentarios.m3u:Cartoons', "directory", {
            title: 'Documentários',
    ...
    if (!service.disableSampleList) {
			page.model.contents = 'grid';
		var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/menu/menu_filmes.m3u:Movies', "directory", {
            title: 'Filmes',
    ...
    if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/menu/menu_series.m3u:Series', "directory", {
            title: 'Séries',
	...
	if (!service.disableSampleXMLList) {
	 	page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/menu/menu_music.m3u:Music', "directory", {
            title: 'Música',
	...
	if (!service.disableSampleList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/ss-iptv/ps3tv/main/menu/menu_canais.m3u:IPTV', "directory", {
            title: 'TV',
